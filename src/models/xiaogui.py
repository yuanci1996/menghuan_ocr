...
class XiaoGui:
    def __init__(self, ocr_text="", map_name="", x=0, y=0, desc="", monster_name="", map_info=None, position_area=None):
        if map_info is None:
            map_info = Map()
    ...
    def __str__(self):
        return (f"XiaoGui(ocr_text={self.ocr_text}, map_name={self.map_name}, "
                f"x={self.x}, y={self.y}, desc={self.desc}, monster_name={self.monster_name}), "
